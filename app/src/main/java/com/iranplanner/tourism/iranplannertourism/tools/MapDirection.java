...
import com.iranplanner.tourism.iranplannertourism.entity.ItineraryLodgingCity;
...
//    LocationRequest mLocationRequest;
    ...
    public List<Marker> readytoDirect() {
        ...
        MarkerOptions options = new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_eye));
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                ...
                DataParserMap parser = new DataParserMap();
